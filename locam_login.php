...
if(isset($_REQUEST['login']))  //name
{
	...
	//echo "donnnee";
	$lgn="select * from locam where user='$user' AND pass='$pass' AND tmid='$tmid' "; //agar match karegi values AND  returns 1 when both same..count kitni no. of rows affect hui lgn se...wo batata hai
		...
		if($chk==1)  //IF INSERT get success then ...
	{
		...
		<script type="text/javascript">
			alert('login success');
			window.location="locam_prof.php";
...
<caption><h1 font-size="20px" style="color: white;" ><u><b>Login Here</b></u></h1></caption>
 ...
 <br>
	...
	<td><h2><a href="locam_reset_pass.php">Forgot Password?</a></h2></td>
	</tr>  
	<tr>
	<td></td>
