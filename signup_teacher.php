...
if(isset($_REQUEST['submit']))
{
	...
	{       //$dol = $_REQUEST['dol'];
		...
		else
		{
			...
			$ins="insert into teacher(probation,empid,pass,user,email,phone_no,pan_no,gid,bloodg,aadhar_no,address,doj,school) values ('$probation','$empid','$pass','$user','$email','$phone_no','$pan_no','$gid','$bloodg','$aadhar_no','$address','$doj','$school')";
