...
if(isset($_REQUEST['login']))  //name
{
	...
	//echo "donnnee";
	$lgn="select * from teacher_mentor where user='$user' AND pass='$pass' AND tmid='$tmid' "; //agar match karegi values AND  returns 1 when both same..count kitni no. of rows affect hui lgn se...wo batata hai
...
<caption><h1 font-size="20px" style="color: white;" ><u><b>Login Here</b></u></h1></caption>
	...
	<td></td>
		...
		<td><h2><a href="tm_reset_pass.php">Forgot Password?</a></h2></td>
	</tr>
