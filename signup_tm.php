...
if(isset($_REQUEST['submit']))
{
	...
	{       //$dol = $_REQUEST['dol'];
		...
		$ins="insert into teacher(probation,empid,pass,user,email,phone_no,pan_no,gid,bloodg,aadhar_no,address,doj,dol,school,tmid) values ('$probation','$empid','$pass','$user','$email','$phone_no','$pan_no','$gid','$bloodg','$aadhar_no','$address','$doj','$dol','$school','$tmid')";
		...
		else
		{
			...
			$ins="insert into teacher_mentor(probation,empid,pass,user,email,phone_no,pan_no,gid,bloodg,aadhar_no,address,doj,school,tmid) values ('$probation','$empid','$pass','$user','$email','$phone_no','$pan_no','$gid','$bloodg','$aadhar_no','$address','$doj','$school','$tmid')";
